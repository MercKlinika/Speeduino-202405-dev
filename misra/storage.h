 ...
 * | 3686       |60         | Page CRC32 sums (4x15)               | Last first, 15 -> 1                |
 * | 3746       |1           | Baro value saved at init             | @ref EEPROM_LAST_BARO              |
 * | 3747       |64          | O2 Calibration Bins                  | @ref EEPROM_CALIBRATION_O2_BINS    |
 * | 3811       |32          | O2 Calibration Values                | @ref EEPROM_CALIBRATION_O2_VALUES  |
 * | 3843       |64          | IAT Calibration Bins                 | @ref EEPROM_CALIBRATION_IAT_BINS   |
 * | 3907       |64          | IAT Calibration Values               | @ref EEPROM_CALIBRATION_IAT_VALUES |
 * | 3971       |64          | CLT Calibration Bins                 | @ref EEPROM_CALIBRATION_CLT_BINS   |
 * | 4035       |64          | CLT Calibration Values               | @ref EEPROM_CALIBRATION_CLT_VALUES |
 * | 4099       |            | END                                  |                                    |
 *
 */
...
#define EEPROM_CONFIG15_END   3480
