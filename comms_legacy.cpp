...
void sendPageASCII()
{
  switch (currentPage)
  {
    ...
    case boostvvtPage2:
      ...
      serial_print_space_delimited_array(configPage15.idleBat);
      serial_println_range((byte *)&configPage15, configPage15.voltage2CorrectionBins);
      serial_print_space_delimited_array(configPage15.voltage2CorrectionBins);
