...
struct table2D idleVCorrectionTable; ///< 6 bin idle voltage correction (2D)
...
byte pinBIEG;   //Input for triggering Idle Up
...
byte pinGEAR; //Input for triggering closed throttle state
