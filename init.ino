...
{   
    ...
    */
    ...
    idleVCorrectionTable.valueSize = SIZE_BYTE;
    idleVCorrectionTable.axisSize = SIZE_BYTE; //Set this table to use byte axis bins
    idleVCorrectionTable.xSize = 6;
    idleVCorrectionTable.values = configPage15.idleBat;
    idleVCorrectionTable.axisX = configPage15.voltage2CorrectionBins;
...
// #endif
  ...
  if( (configPage15.BIEGEnabled > 0) && (!pinIsOutput(pinBIEG)) )
  {
    if (configPage15.BIEGPolarity == 0) { pinMode(pinBIEG, INPUT_PULLUP); } //Normal setting
    else { pinMode(pinBIEG, INPUT); } //inverted setting
  }
